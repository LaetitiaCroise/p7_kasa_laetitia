...
// je récupère logement en créant la fonction  Rate avec en paramètre "logement" pour récuperer ensuite son ratonScore allant de 1 à 5 (étoiles)
...
return (
    <div>
            ...
            {ratingScore.map((ratingElem) => // Je boucle en passant chaque élement du tableau avec map pour retourné le résultat (ratingElem)
